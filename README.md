...
Targeted SQL queries and Python EDA regarding various business questions can be found here.
An interactive Power BI dashboard used to report and explore these trends can be found here.
